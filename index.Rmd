...
print("Dimension of training", quote=FALSE)
dim(training)
cat("\n")
print("Dimension of testing", quote=FALSE)
dim(testing)
```

**a) Reduce the number of features**

Analyze the first 10 rows of the dataset.
...
print("Dimension of TrainSet", quote=FALSE)
dim(TrainSet)
cat("\n")
print("Dimension of TestSet", quote=FALSE)
dim(TestSet)
```
